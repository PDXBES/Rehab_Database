...
/****** Object:  StoredProcedure [GIS].[nBCRChart]    Script Date: 7/16/2019 10:09:11 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [GIS].[nBCRChart] @userName nvarchar(128), @maxBudget float, @maxYearsToFailure float, @minnBCR float, @minHansenRating float
AS
BEGIN
