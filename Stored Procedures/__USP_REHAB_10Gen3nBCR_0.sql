...
/****** Object:  StoredProcedure [dbo].[__USP_REHAB_10Gen3nBCR_0]    Script Date: 7/16/2019 9:45:35 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  ...
  INSERT INTO REHAB.GIS.REHAB_Branches(COMPKEY, [InitialFailYear], std_dev, ReplaceCost, SpotCost, /*LineCostwSpots,*/ LineCostNoSpots, grade_h5, globalID)
...
GROUP BY X.COMPKEY
  ...
  UPDATE  REHAB.GIS.REHAB_Branches
  SET     nBCR_OC = ((BPW - APWOC))//*APWOC01*/(APWOC)
  
  UPDATE  REHAB.GIS.REHAB_Branches
  SET     nBCR_CIPP = ISNULL((BPW-APWCIPP)//*APWCIPP01*/APWCIPP, -10)       
  
  UPDATE  REHAB.GIS.REHAB_Branches
  SET     nBCR_SP = ISNULL((BPW-APWSP)//*APWSP01*/APWSP, -10)
