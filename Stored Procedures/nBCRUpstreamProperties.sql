...
/****** Object:  StoredProcedure [GIS].[nBCRUpstreamProperties]    Script Date: 7/16/2019 10:11:14 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [GIS].[nBCRUpstreamProperties] @userName nvarchar(128), @maxBudget float, @maxYearsToFailure float, @minnBCR float, @minHansenRating float
AS
BEGIN
